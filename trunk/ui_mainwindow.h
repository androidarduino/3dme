...
**
** Created: Sat Jan 1 13:42:35 2011
...
public:
    ...
    QAction *actionUndo;
    QAction *actionRedo;
    QAction *actionCancel_Edit;
    QAction *actionSave_Edit_Frame;
    ...
    QToolButton *moveStepUp_2;
    QToolButton *moveStepDown_2;
    QFrame *actionEditor;
    QVBoxLayout *verticalLayout_2;
    QLabel *label_3;
    QHBoxLayout *horizontalLayout_7;
    QComboBox *actions;
    QToolButton *addKeyFrame_2;
    QToolButton *removeKeyFrame_2;
    QLabel *label_6;
    QListWidget *keyframes;
    QHBoxLayout *horizontalLayout_5;
    QToolButton *addKeyFrame;
    QToolButton *removeKeyFrame;
    QToolButton *moveKeyFrameStepUp;
    QToolButton *moveKeyFrameStepDown;
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        actionCancel_Edit = new QAction(MainWindow);
        actionCancel_Edit->setObjectName(QString::fromUtf8("actionCancel_Edit"));
        actionSave_Edit_Frame = new QAction(MainWindow);
        actionSave_Edit_Frame->setObjectName(QString::fromUtf8("actionSave_Edit_Frame"));
        ...
        addFrame = new QToolButton(frame);
        addFrame->setObjectName(QString::fromUtf8("addFrame"));

        horizontalLayout_6->addWidget(addFrame);

        removeFrame = new QToolButton(frame);
        removeFrame->setObjectName(QString::fromUtf8("removeFrame"));

        horizontalLayout_6->addWidget(removeFrame);

        moveStepUp_2 = new QToolButton(frame);
        moveStepUp_2->setObjectName(QString::fromUtf8("moveStepUp_2"));

        horizontalLayout_6->addWidget(moveStepUp_2);

        moveStepDown_2 = new QToolButton(frame);
        moveStepDown_2->setObjectName(QString::fromUtf8("moveStepDown_2"));

        horizontalLayout_6->addWidget(moveStepDown_2);
        ...
        horizontalLayout_7->addWidget(actions);

        addKeyFrame_2 = new QToolButton(actionEditor);
        addKeyFrame_2->setObjectName(QString::fromUtf8("addKeyFrame_2"));

        horizontalLayout_7->addWidget(addKeyFrame_2);

        removeKeyFrame_2 = new QToolButton(actionEditor);
        removeKeyFrame_2->setObjectName(QString::fromUtf8("removeKeyFrame_2"));

        horizontalLayout_7->addWidget(removeKeyFrame_2);


        verticalLayout_2->addLayout(horizontalLayout_7);

        label_6 = new QLabel(actionEditor);
        ...
        addKeyFrame = new QToolButton(actionEditor);
        addKeyFrame->setObjectName(QString::fromUtf8("addKeyFrame"));

        horizontalLayout_5->addWidget(addKeyFrame);

        removeKeyFrame = new QToolButton(actionEditor);
        removeKeyFrame->setObjectName(QString::fromUtf8("removeKeyFrame"));

        horizontalLayout_5->addWidget(removeKeyFrame);

        moveKeyFrameStepUp = new QToolButton(actionEditor);
        moveKeyFrameStepUp->setObjectName(QString::fromUtf8("moveKeyFrameStepUp"));

        horizontalLayout_5->addWidget(moveKeyFrameStepUp);

        moveKeyFrameStepDown = new QToolButton(actionEditor);
        moveKeyFrameStepDown->setObjectName(QString::fromUtf8("moveKeyFrameStepDown"));

        horizontalLayout_5->addWidget(moveKeyFrameStepDown);
        ...
        label_7 = new QLabel(actionEditor);
        ...
        horizontalLayout_8->addWidget(delay);
        ...
        label_8 = new QLabel(actionEditor);
        ...
        horizontalLayout_9->addWidget(curve);


        verticalLayout_2->addLayout(horizontalLayout_9);

        label_5 = new QLabel(actionEditor);
        ...
        checkBox = new QCheckBox(actionEditor);
        ...
        menuModel->addSeparator();
        menuModel->addAction(actionUndo);
        menuModel->addAction(actionRedo);
        menuModel->addAction(actionCancel_Edit);
        menuModel->addAction(actionSave_Edit_Frame);
        ...
        mainToolBar->addSeparator();
        mainToolBar->addAction(actionCancel_Edit);
        mainToolBar->addAction(actionSave_Edit_Frame);
    ...
    void retranslateUi(QMainWindow *MainWindow)
    {
        ...
        actionCancel_Edit->setText(QApplication::translate("MainWindow", "Cancel Edit Frame", 0, QApplication::UnicodeUTF8));
        actionSave_Edit_Frame->setText(QApplication::translate("MainWindow", "Save Edit Frame", 0, QApplication::UnicodeUTF8));
        ...
        moveStepUp_2->setText(QApplication::translate("MainWindow", "^", 0, QApplication::UnicodeUTF8));
        moveStepDown_2->setText(QApplication::translate("MainWindow", "v", 0, QApplication::UnicodeUTF8));
        ...
        addKeyFrame_2->setText(QApplication::translate("MainWindow", "+", 0, QApplication::UnicodeUTF8));
        removeKeyFrame_2->setText(QApplication::translate("MainWindow", " -", 0, QApplication::UnicodeUTF8));
        label_6->setText(QApplication::translate("MainWindow", "Key Frames", 0, QApplication::UnicodeUTF8));
        addKeyFrame->setText(QApplication::translate("MainWindow", "+", 0, QApplication::UnicodeUTF8));
        removeKeyFrame->setText(QApplication::translate("MainWindow", " -", 0, QApplication::UnicodeUTF8));
        moveKeyFrameStepUp->setText(QApplication::translate("MainWindow", "^", 0, QApplication::UnicodeUTF8));
        moveKeyFrameStepDown->setText(QApplication::translate("MainWindow", "v", 0, QApplication::UnicodeUTF8));
        label_7->setText(QApplication::translate("MainWindow", "Delay", 0, QApplication::UnicodeUTF8));
        delay->setSuffix(QString());
        label_8->setText(QApplication::translate("MainWindow", "Curve", 0, QApplication::UnicodeUTF8));
        curve->clear();
        curve->insertItems(0, QStringList()
         ...
         << QApplication::translate("MainWindow", "Grove", 0, QApplication::UnicodeUTF8)
        );
        label_5->setText(QApplication::translate("MainWindow", "Preview", 0, QApplication::UnicodeUTF8));
        ...
        checkBox->setText(QApplication::translate("MainWindow", "Loop", 0, QApplication::UnicodeUTF8));
