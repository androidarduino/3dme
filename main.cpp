...
int main(int argc, char** argv)
{
    ...
    //Q3dsScene scene;
    Q3dsModel hair("hair.3ds", "hair");
    Q3dsModel head("head.3ds", "head");
    Q3dsModel body("body.3DS", "body");
    Q3dsModel arm("arm.3ds", "left arm");
    Q3dsModel smallarm("arm.3ds", "left small arm");
    Q3dsModel leg("arm.3ds", "left leg");
    Q3dsModel shank("arm.3ds", "left shank");
    Q3dsModel arm1("arm.3ds", "right arm");
    Q3dsModel smallarm1("arm.3ds", "right small arm");
    Q3dsModel leg1("arm.3ds", "right leg");
    Q3dsModel shank1("arm.3ds", "right shank");
    ...
    hair.move(-2,2,3);
    body.moveTo(0,0,0);
    //arm.defaultColor=QColor().fromRgb(255,0,255);
    hair.replaceColor("Material #2", QColor::fromRgbF(0,0,0,1));
    ...
    Q3dsScene* scene=mainwindow.scene();
    //scene->selectedComponent=&arm;
    scene->models.append(&arm);
    //scene->resize(600,600);
    mainwindow.updateModels();
    mainwindow.show();
    /*QDomDocument doc;
    doc.appendChild(body.toXml(&doc));
    qDebug()<<doc.toString();
*/
    /*
